...
export function AdminShell({
  ...
  return (
    <main className="logged-area-shell relative isolate min-h-dvh w-full max-w-full overflow-x-hidden bg-[#fffdf3] text-zinc-950">
      ...
      <div className="relative z-10 w-full max-w-full min-w-0 xl:block xl:min-h-dvh">
        <aside className="hidden border-r border-[#d8ddcf]/90 bg-[#fffefa]/88 px-6 py-6 backdrop-blur xl:fixed xl:inset-y-0 xl:left-0 xl:z-40 xl:block xl:w-[290px] xl:overflow-hidden">
        ...
        <div className="min-w-0 max-w-full overflow-x-hidden xl:ml-[290px]">
      ...
      <nav data-mobile-admin-nav className="fixed inset-x-3 bottom-[calc(0.75rem+env(safe-area-inset-bottom))] z-40 rounded-[24px] border border-[#d8ddcf]/95 bg-[#fffefa]/94 p-2 shadow-[0_18px_50px_rgba(79,97,70,0.16)] backdrop-blur xl:hidden">
